...
- Web Browser LLMs (Perplexity, ChatGPT, Claude Web, etc.) and Antigravity (or other IDE) and Claude Desktop can all use Endeavor Core.

### Tasks

- Configure Claude Desktop to talk to the MCP server.
- Configure Antigravity (or other IDE) similarly.
